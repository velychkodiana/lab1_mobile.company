...
public class ConsoleMenu {
    ...
    private void addTariff() {
        ...
        scanner.nextLine();
        Tariff tariff = new Tariff(name, fee, minutes, data, clients);
   ...
   private void findTariffByRange() {
       ...
       List<Tariff> foundTariffs = database.getTariffs().stream()
               .filter(tariff -> tariff.getSubscriptionFee() >= minFee && tariff.getSubscriptionFee() <= maxFee)
               .toList(); 
