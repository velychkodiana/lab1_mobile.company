...
class ConsoleMenuTest {
    ...
    public void testAddTariff() {
        ...
        // додаємо новий тариф
        Tariff newTariff = new Tariff("NewTariff", 300.0, 100, 10, 5000);
    ...
    public void testRemoveTariff() {
        ...
        Tariff tariffToRemove = new Tariff("RemoveMe", 250.0, 200, 5, 3000);
    ...
    public void testCountClientsByTariff() {
        // додаємо новий тариф
        Tariff newTariff = new Tariff("PopularTariff", 100.0, 150, 5, 10000);
